...
BCE_CONFIG="configs/snomed_icd9cm_d_option_a_matrix_bce.yaml"
BCE_FINETUNE_CONFIG="configs/snomed_icd9cm_d_option_a_matrix_bce_finetune.yaml"
BGE_CONFIG="configs/snomed_icd9cm_d_option_a_matrix_bge_m3.yaml"
PUBMED_CONFIG="configs/snomed_icd9cm_d_option_a_matrix_pubmedbert.yaml"
PUBMED_FINETUNE_CONFIG="configs/snomed_icd9cm_d_option_a_matrix_pubmedbert_finetune.yaml"
DIRECTIONAL_CONFIG="configs/snomed_icd9cm_d_option_a_directional.yaml"
DIRECTIONAL_FINETUNE_CONFIG="configs/snomed_icd9cm_d_option_a_directional_finetune.yaml"

BCE_ENTITY_MAX_CONFIG="configs/snomed_icd9cm_d_option_a_matrix_bce_C_entity_max.yaml"
BCE_NAME_ONLY_CONFIG="configs/snomed_icd9cm_d_option_a_matrix_bce_D_name_only.yaml"
BCE_CONTEXT_ONLY_CONFIG="configs/snomed_icd9cm_d_option_a_matrix_bce_D_context_only.yaml"
BCE_PATH_ONLY_CONFIG="configs/snomed_icd9cm_d_option_a_matrix_bce_D_path_only.yaml"
